...
class Indexed:
    ...
    def get_autocomplete_search_fields(cls):
        """
        Return the list of AutocompleteField entries in this model's search_fields, with duplicates removed.
        :return: The list of AutocompleteField entries in this model's search_fields.
        :rtype: list
        """
        return [
            field
